...
import { useAppConfiguration, useConfigurationStatus, AppConfigurationProvider } from "@/lib/app-configuration-context-v2"
...
function TestBulletproofConfigContent() {
  ...
  const [testResults, setTestResults] = useState<TestEntry[]>([])
