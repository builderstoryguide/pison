/**
 * Resolve HEC 1–5 class IDs and verify class_subjects.
 * Run: npx tsx scripts/resolve_hec_classes.ts
 */
...
async function main() {
  ...
  const HEC = classGroups.filter((g) => g.userClassName.startsWith('Hec'))
