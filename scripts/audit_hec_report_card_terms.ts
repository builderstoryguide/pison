/**
 * Audit HEC 1–5 report card Term 1/2/3 columns via student-report API (full cohort).
 * Run: npx tsx scripts/audit_hec_report_card_terms.ts
...
async function main() {
  ...
  console.log('=== HEC class resolution & class_subjects check ===\n')
  ...
  const outPath = path.join(outDir, 'hec-report-card-terms-audit.json')
