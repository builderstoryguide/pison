...
-- Canonical copy: supabase/migrations/20260518025219_sequence_term_counts.sql
-- Run via CLI: npm run db:migrate:sequences  (after npm run db:link and supabase login)
