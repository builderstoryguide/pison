-- =====================================================
-- Robust Assignments Setup Script
-- Run this in your Supabase SQL Editor
-- This script handles common errors and can be run multiple times
-- =====================================================
...
DROP INDEX IF EXISTS idx_assignment_submissions_teacher_id;
...
CREATE INDEX idx_assignment_submissions_teacher_id ON assignment_submissions(teacher_id);
...
EXCEPTION
    WHEN OTHERS THEN
        -- If storage setup fails, just log it and continue
